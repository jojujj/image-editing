...
function initLightbox()
{
	...
	//create imagepanner div
	var objImagePanner = document.createElement("div");
	objImagePanner.setAttribute('class','pancontainer');
	objImagePanner.setAttribute('data-canzoom','yes');
	objImagePanner.setAttribute('data-orient','center');	
	objLightbox.appendChild(objImagePanner);
	...
	objImagePanner.appendChild(objLink);
	...
	objImagePanner.appendChild(objLightboxDetails);
